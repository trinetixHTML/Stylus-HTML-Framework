...
3. cd /d путь_в_папку_с_проектом 
4. npm i (на варнинги не обращаем внимание)
5. gulp
...
!!!!!ВАЖНО!!!!!
папка ./src/sprites обязательно должа соджердать хотя бы один файл для корректной работы. по этому в ней лежит spacer.png который не удалять
-------------------------------------------------------------------------------------------
	использование
	-------------
...
!!!!!ВАЖНО!!!!!
папка ./src/images обязательно должа соджердать хотя бы один файл для корректной работы. по этому в ней лежит spacer.png который не удалять
-------------------------------------------------------------------------------------------
6. минимизируем css с помощью gulp-minify-css - https://github.com/jonathanepollack/gulp-minify-css
